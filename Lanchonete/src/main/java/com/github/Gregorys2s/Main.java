...
public class Main {
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                java.awt.EventQueue.invokeLater(() -> {
                    new MenuInicial(config.getCardapioController(),config.getPedidosController(),config.getIngredientesController(),config.getRelatorioController(),config.getCaixaController(),config.getRelatoriosSemanalesController(),config.getPagamentoController()).setVisible(true);
                });

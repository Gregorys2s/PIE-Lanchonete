...
public class RelatorioDiarioServiceLmpl implements RelatorioDiarioService{
    ...
    public RelatorioDiarioServiceLmpl(RelatorioDiarioRepository relatorioRepository,
